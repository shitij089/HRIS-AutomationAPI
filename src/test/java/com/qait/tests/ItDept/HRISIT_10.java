...
public class HRISIT_10 {
	...
	public void Step03_UpdateOnsitePunchesForGivenWeek() throws ParseException {
		...
		test.timePage.updatePunchesForWeek(startDate, punches, "Account");
	}

	@Test(dependsOnMethods = "Step03_UpdateOnsitePunchesForGivenWeek")
	public void Step04_HSLAppliedSuccessfully() {
	...
	@Test(dependsOnMethods = "Step04_HSLAppliedSuccessfully", alwaysRun = true)
