...
public class HRISIT_09 {
	...
	public void Step00_OpenBrowserWindow() {
		...
		empName = DataReadWrite
				.getProperty("ItDepartmentEmployeeFullName");
		savePunchesForWeek();
	    username=DataReadWrite
				.getProperty("ItDepartmentEmployeeFirstName")+DataReadWrite
				.getProperty("ItDepartmentEmployeeLastName");
	}
	...
	public void Step01_loginIntoApplication() {
		...
		startDate=test.homePage.getStartDateOfWeekToBeTested(monthAfter, weekNo);
	}
	@Test(dependsOnMethods="Step01_loginIntoApplication")
	public void Step02_CancelAllLeaveWichExistsInWeekHAvingStartDate()
	{
		test.leavePage.cancelAllLeavesInWeekHavingWeekStartDateAsGiven(startDate, empName, empId,monthAfter);
	}
	
	@Test(dependsOnMethods="Step02_CancelAllLeaveWichExistsInWeekHAvingStartDate")
	public void Step03_AssignManagerToAnyEmployeeId() throws ParseException, InterruptedException {
	...
	public void Step04_UpdateOnsitePunchesForGivenWeek() throws ParseException {
	...
	public void Step05_CreateCredentialForNewEmployee() throws ParseException, InterruptedException {
		test.homePage.switchToDefaultContent();
	...
	public void Step06_LoginWithUserAccountIdForApplyPTO() throws ParseException, InterruptedException {
		test.launchApplication();
	...
	public void Step07_VerifyPTOAppliedSuccessfullyByEmployee() {
		...
		test.timePage.verifyTimeValueForTheGivenDateIsEqualToTheGivenValue(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 4), empId, "PTO");
	}


	@Test(dependsOnMethods="Step07_VerifyPTOAppliedSuccessfullyByEmployee")
	public void Step08_LoginWithManagerIdForCancelLeave() throws ParseException, InterruptedException {
		test.launchApplication();
	...
	public void Step09_verifyCancelLeaveByManager() throws ParseException, InterruptedException {
		test.homePage.navigateToTimeTab();
		test.homePage.navigateToLeaveTab();
		test.leavePage
