...
public class HRISIT_03 {
	...
	public void Step04_VerifyThatThereShouldBeAFullLWPIfWorkingHourForTheDayISLessThen5() {
		test.homePage.switchToDefaultContent();
		test.homePage.navigateToTimeTab();
		...
		test.timePage.verifyFullDayLWPIfWorkingHourIsLessThan5(empId,
