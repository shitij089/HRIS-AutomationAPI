...
public class HRISTPA_03 {
	...
	public void Step04_VerifyingFullDayLWPOnDayWithHourLessThan5() {
		test.homePage.switchToDefaultContent();
		test.homePage.navigateToTimeTab();
		...
		test.timePage
				.verifyFullDayLWPIfWorkingHourIsLessThan5(empId, startDate,department);
	}
