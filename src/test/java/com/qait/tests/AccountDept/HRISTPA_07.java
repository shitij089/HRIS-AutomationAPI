...
public class HRISTPA_07 {
	...
	public void Step00_OpenBrowserWindow() {
		...
		username = DataReadWrite
				.getProperty("AccountDepartmentEmployeeFirstName")
				+ DataReadWrite
						.getProperty("AccountDepartmentEmployeeLastName");
		department="Account";
	}
	...
	public void Step07_VerifyPTOAppliedSuccessfullyByEmployee() {
		...
		test.timePage.verifyTimeValueForTheGivenDateIsEqualToTheGivenValue(
				DateUtil.getNextDateFromGivenDateFoGivenDateModule(
						"yyyy-MM-dd", "day", startDate, 5), empId, "PTO");
	}
	...
	public void Step09_verifyCancelledLeaveByManager() throws ParseException {
		test.homePage.navigateToTimeTab();
		test.homePage.navigateToLeaveTab();
		test.leavePage.clickOnApprovalLeave(DateUtil.getNextDateFromGivenDateFoGivenDateModule(
				"MMMyyyy",
				"month",
		...
		test.timePage.verifyfirstValueContainsSecond(test.timePage
				.getInfoAtGivenDate(DateUtil
						.getNextDateFromGivenDateFoGivenDateModule(
								"yyyy-MM-dd", "day", startDate, 5), empId),
