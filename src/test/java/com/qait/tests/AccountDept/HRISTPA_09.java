...
public class HRISTPA_09 {
	...
	public void Step04_HPTOAppliedSuccessfully() {
		...
		test.timePage.verifyHPTOMessageForGivenDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 5), empId, "Approved PTO Request");
	}

	@Test(dependsOnMethods = "Step04_HPTOAppliedSuccessfully", alwaysRun = true)
