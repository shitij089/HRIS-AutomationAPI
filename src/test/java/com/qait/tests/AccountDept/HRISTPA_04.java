...
public class HRISTPA_04 {
	...
	public void Step04_VerifyingPTOAppliedSuccessfully() {
		...
		test.timePage.verifyPTOAppliedSuccessfully(empId, startDate);
	}

	@Test(dependsOnMethods = "Step04_VerifyingPTOAppliedSuccessfully", alwaysRun = true)
