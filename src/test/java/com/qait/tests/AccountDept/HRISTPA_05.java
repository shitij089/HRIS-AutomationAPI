...
public class HRISTPA_05 {
	...
	public void Step04_VerifySingleLwpIfTotalHoursForRemainingDaysAreGreaterOrEqual45() {
		test.homePage.switchToDefaultContent();
		test.homePage.navigateToTimeTab();
		...
		test.timePage.verifySingleLWPIfInRemainingDaysTotalHoursIs45(empId,
				startDate);
	}
