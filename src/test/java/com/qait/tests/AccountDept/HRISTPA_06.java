...
public class HRISTPA_06 {
	...
	public void Step04_VerifyHalfSLAppliedSuccessfully() {
		...
		test.timePage.verifyHSLAppliedSuccessfully(empId, startDate);

	}

	@Test(dependsOnMethods = "Step04_VerifyHalfSLAppliedSuccessfully", alwaysRun = true)
