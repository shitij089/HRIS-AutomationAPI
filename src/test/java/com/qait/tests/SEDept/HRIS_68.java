...
public class HRIS_68 {
	...
	public void Step04_ApplyBOOTOForGivenDate() {
		...
		test.leavePage.selectEndDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate1, 4));
		test.leavePage.sendTotalHours(8);
		test.leavePage.sendComment("No Comment");
	...
	@Test(dependsOnMethods = "Step04_ApplyBOOTOForGivenDate")
	public void Step05_VerifyThatThereIsNoSandwitchInSatSunWhichOccurBetweenAppliedBOOTO() {
		test.homePage.switchToDefaultContent();
		test.homePage.navigateToTimeTab();
	...
	@Test(dependsOnMethods = "Step05_VerifyThatThereIsNoSandwitchInSatSunWhichOccurBetweenAppliedBOOTO", alwaysRun = true)
