...
public class HRIS_TC_64_VerifySystemAddBOOTOHoursInTotalWorkHoursOfAWeek {
	...
	public void Step04_VerifyBOOTOAppliedSuccessfully() {
	...
	@Test(dependsOnMethods = "Step04_VerifyBOOTOAppliedSuccessfully", alwaysRun = true)
