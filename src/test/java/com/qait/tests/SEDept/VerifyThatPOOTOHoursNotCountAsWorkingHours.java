...
public class VerifyThatPOOTOHoursNotCountAsWorkingHours {
	...
	public void Step04_VerifyPOOTOAppliedSuccessfully() {
		test.homePage.navigateToLeaveTab();
		test.leavePage.navigateToAssignLeaveTab();
		test.leavePage.selectLeaveType("Personal OOTO");
		...
		test.timePage.verifyTimeValueForTheGivenDateIsEqualToTheGivenValue(
				DateUtil.getNextDateFromGivenDateFoGivenDateModule(
						"yyyy-MM-dd", "day", startDate, 4), empId, "POOTO");
		Assert.assertEquals(
				test.timePage.getWeekHourValueWhichHaveGivenDate(startDate),
				"32:00");
	}
