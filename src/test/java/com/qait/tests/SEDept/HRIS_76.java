...
public class HRIS_76 {
	...
	public void Step03_UpdateOnsitePunchesForGivenWeek() {
		...
		test.timePage.updatePunchesForWeek(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate1, 4), punches, "se");
	}

	@Test(dependsOnMethods = "Step03_UpdateOnsitePunchesForGivenWeek")
	public void Step04_ApplyPlannedLeavesForGivenDate() {
	...
	@Test(dependsOnMethods = "Step04_ApplyPlannedLeavesForGivenDate")
	public void Step05_VerifyThatThereIsSandwitchInSatSunWhichOccurBetweenPTOApplied() {
		test.homePage.switchToDefaultContent();
		test.homePage.navigateToTimeTab();
	...
	@Test(dependsOnMethods = "Step05_VerifyThatThereIsSandwitchInSatSunWhichOccurBetweenPTOApplied", alwaysRun = true)
