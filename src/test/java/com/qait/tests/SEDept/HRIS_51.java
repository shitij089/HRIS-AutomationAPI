...
public class HRIS_51 {
	...
	public void Step04_VerifyFullDaySickLeaveAppliedSuccessfully() {
	...
	@Test(dependsOnMethods = "Step04_VerifyFullDaySickLeaveAppliedSuccessfully", alwaysRun = true)
