...
public class HRIS_67 {
	...
	public void Step04_ApplyPTOForGivenDate() {
	...
	@Test(dependsOnMethods = "Step04_ApplyPTOForGivenDate")
	public void Step05_VerifyThatThereIsNoSandwitchInSatSunWhichOccurBetweenPTOLeaveApplied() {
		test.homePage.switchToDefaultContent();
		test.homePage.navigateToTimeTab();
	...
	@Test(dependsOnMethods = "Step05_VerifyThatThereIsNoSandwitchInSatSunWhichOccurBetweenPTOLeaveApplied", alwaysRun = true)
