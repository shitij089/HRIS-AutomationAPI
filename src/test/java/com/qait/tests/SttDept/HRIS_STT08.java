...
public class HRIS_STT08 {
	...
	public void Step05_HalfPTOAppliedSuccessfully() {
		...
		test.timePage.verifyHPTOMessageForGivenDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 4), empId, "Approved PTO Request");
	}

	@Test(dependsOnMethods = "Step05_HalfPTOAppliedSuccessfully", alwaysRun = true)
