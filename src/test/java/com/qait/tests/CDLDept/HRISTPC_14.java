...
public class HRISTPC_14 {
	...
	public void Step05_CompOffAppliedSuccessfully() {
		...
		test.leavePage.selectDateForApplyingCompOffDateAtParticularDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 6));
		...
		test.leavePage.selectEndDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 8));
		test.leavePage.selectDuration("Full Day");
		...
		test.timePage.verifyCompOffMessageForGivenDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 8), empId,"Approved CO Request");
	}
	
	@Test(dependsOnMethods = "Step05_CompOffAppliedSuccessfully", alwaysRun = true)
