...
public class HRISTPC_10 {
	...
	public void Step00_OpenBrowserWindow() {
		...
		savePunchesForWeek();
		username = DataReadWrite.getProperty("CdlDepartmentEmployeeFirstName")
				+ DataReadWrite.getProperty("CdlDepartmentEmployeeLastName");
	}
	...
	public void Step09_verifyCancelledLeaveByManager() {
		test.homePage.navigateToTimeTab();
		test.homePage.navigateToLeaveTab();
		test.leavePage
