...
public class HRISTPC_24 {
	...
	public void Step05_VerifyFullCompOffHoursAppliedSuccessfully() {
	...
	@Test(dependsOnMethods = "Step05_VerifyFullCompOffHoursAppliedSuccessfully", alwaysRun = true)
