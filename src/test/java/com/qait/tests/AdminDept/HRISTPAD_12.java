...
public class HRISTPAD_12 {
	...
	public void Step04_VerifyWFHAppliedSuccessfully() {
		...
		test.leavePage.selectEndDate(DateUtil
				.getNextDateFromGivenDateFoGivenDateModule("yyyy-MM-dd", "day",
						startDate, 6));
		test.leavePage.sendComment("Test");
	...
	@Test(dependsOnMethods = "Step04_VerifyWFHAppliedSuccessfully", alwaysRun = true)
