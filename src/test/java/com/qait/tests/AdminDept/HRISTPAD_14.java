...
public class HRISTPAD_14 {
	...
	public void Step00_OpenBrowserWindow() {
		...
		username = DataReadWrite
				.getProperty("AdminDepartmentEmployeeFirstName")
				+ DataReadWrite.getProperty("AdminDepartmentEmployeeLastName");
	}
	...
	public void Step07_VerifyPTOAppliedSuccessfullyByEmployee() {
		...
		test.timePage.verifyTimeValueForTheGivenDateIsEqualToTheGivenValue(
				DateUtil.getNextDateFromGivenDateFoGivenDateModule(
						"yyyy-MM-dd", "day", startDate, 6), empId, "PTO");
	}

	@Test(dependsOnMethods = "Step07_VerifyPTOAppliedSuccessfullyByEmployee")
	public void Step08_LoginWithManagerIdForCancelLeave() throws ParseException {
		test.launchApplication();
	...
	public void Step09_verifyCancelLeaveByManager() throws ParseException {
		test.homePage.navigateToTimeTab();
	...
	@Test(dependsOnMethods = "Step09_verifyCancelLeaveByManager")
	public void Step10_verifyCanceledLeaveMsg() {
		...
		test.timePage.verifyfirstValueContainsSecond(test.timePage
				.getInfoAtGivenDate(DateUtil
						.getNextDateFromGivenDateFoGivenDateModule(
								"yyyy-MM-dd", "day", startDate, 6), empId),
				"Canceled PTO Request");
	}
